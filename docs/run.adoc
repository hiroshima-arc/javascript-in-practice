...
exports.default = series(
  ...
  series(
    ...
    parallel(webpack.watch, asciidoctor.watch, jest.watch, marp.watch)
  )
);
...
exports.watch = parallel(webpack.watch, asciidoctor.watch, jest.watch, marp.watch);
```
